    ...
    <div className="min-h-screen bg-background flex flex-col" dir="rtl">
      ...
      >
        <div className="px-4 md:px-6 py-3 flex items-center justify-between gap-3">
          ...
          {/* Left side (RTL end): user menu / login */}
      ...
      <div className="flex-1 flex flex-col md:flex-row min-h-0">
        ...
        <div className="w-full md:w-[55%] flex flex-col order-2">
          {/* --- Heritage row (top) --- */}
          <section
            className="relative px-4 md:px-8 py-5 md:py-6 border-b border-border/40 overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="w-full mx-auto bg-card/80 backdrop-blur-sm rounded-2xl border border-border/50 shadow-card p-5 text-center">
          ...
          {/* --- Gallery (bottom) --- */}
          <section
            className="flex-1 px-4 md:px-8 py-5 md:py-6 flex flex-col min-h-0"
            style={{
              background: "linear-gradient(135deg, hsl(var(--cream)) 0%, hsl(36 40% 92%) 100%)",
            }}
          >
            <div className="w-full mx-auto flex-1 flex flex-col min-h-0 bg-card/80 backdrop-blur-sm rounded-2xl border border-border/50 shadow-card p-5">
              ...
              {/* Grid */}
              <div className="flex-1 min-h-0 overflow-y-auto pb-2 [scrollbar-gutter:stable] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-border/60 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
